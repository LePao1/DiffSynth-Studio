...
def example(pipe, seeds, example_id, global_prompt, entity_prompts):
    dataset_snapshot_download(
        ...
        local_dir="./",
        allow_file_pattern=f"data/examples/eligen/qwen-image/example_{example_id}/*.png",
    )
    masks = [
        Image.open(f"./data/examples/eligen/qwen-image/example_{example_id}/{i}.png").convert("RGB")
...
snapshot_download(
    "DiffSynth-Studio/Qwen-Image-EliGen",
    local_dir="models/DiffSynth-Studio/Qwen-Image-EliGen",
