...
pipe = QwenImagePipeline.from_pretrained(
    ...
    model_configs=[
        ...
        ModelConfig(
            model_id="DiffSynth-Studio/Qwen-Image-Blockwise-ControlNet-Canny", origin_file_pattern="model.safetensors"
        ),
    ],
...
controlnet_inpaint_image = (
    Image.open("./data/example_image_dataset/canny/image_2.jpg").convert("RGB").resize((1328, 1328))
)
...
image = pipe(
    prompt,
    seed=0,
    input_image=controlnet_inpaint_image,
