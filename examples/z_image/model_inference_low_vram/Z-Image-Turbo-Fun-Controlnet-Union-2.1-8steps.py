...
pipe = ZImagePipeline.from_pretrained(
    ...
    model_configs=[
        ModelConfig(
            ...
            origin_file_pattern="Z-Image-Turbo-Fun-Controlnet-Union-2.1-8steps.safetensors",
            **vram_config,
        ),
        ModelConfig(
            model_id="Tongyi-MAI/Z-Image-Turbo", origin_file_pattern="transformer/*.safetensors", **vram_config
        ),
        ModelConfig(
...
image = pipe(
    ...
    height=1024,
    width=1024,
    controlnet_inputs=[ControlNetInput(inpaint_image=inpaint_image, inpaint_mask=inpaint_mask, scale=0.7)],
)
